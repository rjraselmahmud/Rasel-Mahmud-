  ...
  try {
    ...
    if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("🤺janu") || body.startsWith("🤺babu") || body.startsWith("🤺bbz")) {
      ...
      const randomReplies = [
        ...
        "মন খারাপ করলে মনে রেখো, রাসেল সবসময় তোমার পাশে আছে 🤗",
        "তুমি একটুখানি হাসলেই, রাসেলের পুরো দিনের ক্লান্তি উড়ে যায় 😍",
        "জানো? পৃথিবীতে সবচেয়ে মিষ্টি জিনিসটা হলো তোমার হাসি আর রাসেলের ভালোবাসা 💕",
        "রাসেল চায় তুমি সব সময় খুশি থাকো, কারণ তোমার সুখ মানেই রাসেলের সুখ 🌺",
        "কষ্ট যতই আসুক, রাসেল তোমাকে হাসাতে ভুলবে না কখনো 🥰"
      ];
      if (!arr) {
